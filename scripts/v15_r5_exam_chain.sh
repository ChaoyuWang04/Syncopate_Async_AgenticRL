...
for i in $(seq 1 "$PASSES"); do
  $PY scripts/u_exam_run.py --exam "$EXAM" --arm "${ARM}_r$i" --concurrency 4 $LIMIT_ARG \
...
$PY scripts/u_exam_judge_v4.py --context $JL > "logs/v15_r5/judge_${ARM}.log" 2>&1 || { echo "🔴 判卷失败"; tail -20 "logs/v15_r5/judge_${ARM}.log"; exit 1; }
tail -25 "logs/v15_r5/judge_${ARM}.log"
$PY scripts/v15_gate_triage.py > "logs/v15_r5/triage_${ARM}.log" 2>&1 || { echo "🔴 三查失败"; tail -20 "logs/v15_r5/triage_${ARM}.log"; exit 1; }
