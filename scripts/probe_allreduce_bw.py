...
用法：
    python scripts/probe_allreduce_bw.py                    # 默认全套
    python scripts/probe_allreduce_bw.py --devices 0,2      # 只测一组
    python scripts/probe_allreduce_bw.py --bind             # 把进程绑到 GPU 所属 NUMA 节点
"""
