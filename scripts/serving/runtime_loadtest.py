...
"""M9.7 · 全指标压测驱动：把设计文档 §19 那张表逐条打出实测数字。
    ...
    python scripts/serving/runtime_loadtest.py                 # 全部阶段（约 10–20 分钟）
    python scripts/serving/runtime_loadtest.py --skip crash,model_down
    python scripts/serving/runtime_loadtest.py --quick         # 每意图样本减半
