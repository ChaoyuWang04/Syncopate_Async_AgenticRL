...
"""E32 · trace 轨重放客户端（cache/路由结论的唯一合法尺子；random 轨归 vllm bench serve）。
    ...
    .venv/bin/python scripts/serving/b4_replay.py --concurrency 32 --out logs/b4/arm_x_trace.json
    .venv/bin/python scripts/serving/b4_replay.py --base-url http://127.0.0.1:8100 --model sft-base \
