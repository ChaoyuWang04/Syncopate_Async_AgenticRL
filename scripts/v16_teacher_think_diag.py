...
读数：_audit/v16/teacher_think_diag.json（聚合 + 逐样本）· _audit/v16/teacher_think_diag.md（原样 8 条给 Chaoyu 看）
    ...
    SYNCOPATE_CONTRACT=v15 SYNCOPATE_THINK=1 python scripts/v16_teacher_think_diag.py --teacher http://127.0.0.1:8210/v1 --n 20
"""
...
from syncopate.core.model_paths import STUDENT_MODEL, TEST_TOKENIZER  # noqa: E402
from syncopate.pipeline.split import DEFAULT_BATCH_DIR, DEFAULT_SPLIT_DIR  # noqa: E402
