...
用法：
    python scripts/repro_fsdp_hybrid_nosync.py                    # 复现 + 修法对照
    REPRO_APPLY_FIX=1 python scripts/repro_fsdp_hybrid_nosync.py  # 验证我们的补丁把 A/B 变绿
"""
...
def worker(rank: int, world: int) -> None:
    ...
    if rank == 0:
        ...
        payload = {
            ...
            "script": "scripts/repro_fsdp_hybrid_nosync.py",
