...
用法：
    python scripts/infra/parse_fully_async_timing.py logs/rl_v13e1.log
    python scripts/infra/parse_fully_async_timing.py logs/xxx.log --json logs/xxx_timing.json
    python scripts/infra/parse_fully_async_timing.py logs/xxx.log --tail 3   # 只看最后 3 条（稳态）
