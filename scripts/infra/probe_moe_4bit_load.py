...
用法：
    python scripts/infra/probe_moe_4bit_load.py --stage online   --json logs/a9_online.json
    python scripts/infra/probe_moe_4bit_load.py --stage save     --out models/Qwen3-30B-A3B-nf4
    python scripts/infra/probe_moe_4bit_load.py --stage preload  --pre models/Qwen3-30B-A3B-nf4 \\
