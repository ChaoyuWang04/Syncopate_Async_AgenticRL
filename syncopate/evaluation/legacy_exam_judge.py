...
"""U 路 P0 · 承接考场机判 + 说人话考场盲评包生成（`24 §4-P0` 的判据执行件）。
    ...
    .venv/bin/python -m syncopate.evaluation.legacy_exam_judge --context logs/u_route/run_cand_context.jsonl
    .venv/bin/python -m syncopate.evaluation.legacy_exam_judge --blind logs/u_route/run_cand_talk.jsonl \
