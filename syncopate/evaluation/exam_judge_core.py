...
"""v14.5 · exam_v2 机判（`24 §4-P2` 考卷 v2 判据执行件）。
    ...
    .venv/bin/python -m syncopate.evaluation.exam_judge_core --context logs/u_route/run_<arm>_ctxv2.jsonl
...
def judge_item(item, spec):
    ...
    if kind == "unauthorized_reject_v3":
        ...
        return True, "ok"
    # L3/L4 沿用 v1 判据
    from syncopate.evaluation.legacy_exam_judge import judge_item as v1_judge
