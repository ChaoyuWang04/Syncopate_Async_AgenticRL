...
"""v15 · 训练数据画廊：把最终喂进训练的每种数据**逐条解码成可读文本**（Chaoyu 09-02：要亲眼看终态）。
    ...
    SYNCOPATE_CONTRACT=v15 .venv/bin/python -m syncopate.pipeline.data_gallery --parquet data/sft/v15/train.parquet [--per-bucket 3]
    SYNCOPATE_CONTRACT=v15 .venv/bin/python -m syncopate.pipeline.data_gallery --parquet _audit/v16/dry_rows.parquet   # 本机 DRY 演练产物
