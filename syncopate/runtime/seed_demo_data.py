...
"""给 demo 租户播种参考数据 —— **让 agent 有东西可查**。
    ...
    python -m syncopate.runtime.seed_demo_data                 # 播到 org_demo
    python -m syncopate.runtime.seed_demo_data --org org_x     # 换租户
    python -m syncopate.runtime.seed_demo_data --check         # 只报告现状，不写
