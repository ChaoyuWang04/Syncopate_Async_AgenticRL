...
description: ★K 线（27 serving harness 生产化）现场：09-02 K0–K10 ✅（回流两表、考卷 v4 题形导出、版本归因）；下一步 K11 收口（清单/runbook/复盘/灾备演练）；§16 四件已裁（Celery+Redis · PG+Alembic · 快照式恢复 · id 不迁）；坑表 28 · 对照 29；下一步 K1
metadata: 
  node_type: memory
  type: project
