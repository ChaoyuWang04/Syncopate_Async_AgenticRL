...
description: K0–K11 serving 主体施工的历史记录；现行状态看 docs/syncopate/07-SERVING.md，未完成验收看 01-TASKS.md
metadata: 
  node_type: memory
  type: project
...
**历史 K 线 = `docs/archive/syncopate/pre-consolidation-v16/27-serving-harness-plan.md`（施工记录 K0–K11）+ `28-serving-middleware-hazards.md`（坑表）+ `30-serving-release-checklist-and-runbook.md`（上线清单/runbook）。**
