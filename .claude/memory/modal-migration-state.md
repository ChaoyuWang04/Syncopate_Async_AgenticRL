...
description: ★09-04 收口：家在 Modal B200×2 + 全新栈（vLLM 0.28/verl 0.9/torch 2.13/FA4），九步探针全绿；v16 口径、Qwen3.6-35B-A3B 学生/Qwen3.8-27B 教师；S3 建库 run16 跑中；唯一入口 docs/syncopate/31
metadata:
  type: project
---
...
**进度（09-04 00:30）**：环境九步 ✅（FA4 4.0×/1297 TFLOPS · NVLink 871 GB/s=34× · MTP 快 12% · EP=2 起得来）· S0/S1 ✅（Modal 全量 951 passed）· S2 ✅（v16 两地 SHA 同）· **S3 建库 run16 跑中**（run13–15 各撞一个被旧缓存/JSON 假设盖住的老路径）· S4 sft_smoke / S5 exam_v4 已写未跑 · S6 RL / S7 OPD 未写。
