...
metadata: 
  ...
  modified: 2026-08-19T13:34:20.039Z
---
...
真实集成   16 次尝试 / 13+1 处接线（✅ 2026-08-19 下午通了）
分布       主线 1 · verl 缺陷 3 · **我们接错 10**
终账       端到端 **2.31×** —— 微基准的 3.96× 在真实系统兑现 ~70%
```

**第 14 处（最后一处，也最险）**：「Adam dtype 报错」的真身是 **_pg_forward 绕过根 FSDP
