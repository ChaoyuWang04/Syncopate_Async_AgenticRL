...
- [infra 线状态与决策](infra-line-state.md) — ★收尾期·单任务制（08-28）：训练线全闭环（E31 统一 FP8 定界·占空比 31→73.4%），★全线收官（08-28）：E32 serving 单日收官（四卡拓扑 3.86×·goodput 64·PD no-go·ngram 2.3× 进默认），队列空只剩行政等待；入口 docs/infra_exp/00-START.md
