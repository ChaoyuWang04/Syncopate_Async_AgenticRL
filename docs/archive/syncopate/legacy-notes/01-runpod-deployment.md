...
这是 [23-research-question](../pre-consolidation-v16/23-research-question.md) 的前置条件，趁环境热着做：
...
有了它们，[23-research-question](../pre-consolidation-v16/23-research-question.md) §4.2 的 σ² 反解自检就能做了（`σ² ≈ 2·k3_kl − kl²`），**零额外成本**。
