...
> **当前有效的机器画像、带宽口径与焦点，一律以 `docs/infra_exp/00-START.md`
> 和 `docs/syncopate/05-COMPUTE.md` 为准**；焦点是怎么定下来的见
...
（`scripts/archive/legacy_4x5090/install_flash_attn_shim.py` 提供的四个纯 PyTorch gather/scatter），
