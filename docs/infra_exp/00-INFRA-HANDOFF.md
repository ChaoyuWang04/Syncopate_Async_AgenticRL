...
> 📮 **与主线的往来**：他们的问题清单在 [`MAINLINE-HANDOFF-2026-08-18.md`](MAINLINE-HANDOFF-2026-08-18.md)，
> **我们的回信在 [`INFRA-REPLY-TO-MAINLINE-2026-08-19.md`](INFRA-REPLY-TO-MAINLINE-2026-08-19.md)** ——
> 7 项已答 6 项，**还开着 1 项（停机线口径）**；另有 5 件新事欠他们，其中 reward 设计那条是**给他们的活**。
...
🟡 🆕 **E26 PrefixGrouper**：数学/微基准/集成**全通**（3.96× 微基准；根因=绕过根 FSDP 的归约竞态，
   已修并冒烟全绿，方向数 2.12×）；**欠同尺子 A/B + B5 才算结案**（E26 §6.5）
