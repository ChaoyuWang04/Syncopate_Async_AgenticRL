...
🔴 A11🆕 ZeRO-3 在 **4 卡** 上重测            ~20 min  E02   ★★ **A8 直接逼出来的**：A6 的 6.01×
        是在 3 卡 trainer 上量的，而 3 卡正好是 all_gather 塌掉的那个点。
        ⇒ **「分片是净亏损」这个结论目前只在 3 卡上成立**，4 卡可能完全不同。
        不做这一条，Track A 筛子②的成立范围就是错的。
