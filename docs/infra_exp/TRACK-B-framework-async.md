...
>
> ⇒ 欠哪些实验见 **§3.5**；叙事与简历两个版本见
> [`NARRATIVE-AND-RESUME.md`](NARRATIVE-AND-RESUME.md) 第一部分。
...
**⇒ B1–B5 做完，Track B 从 ~50% 到 ~85%，简历版本 B 就能填满。粗估 2–3 天 GPU 时间。**

⚠️ **2026-08-16 的现实约束**：机器已从 4×5090 变成 **1×4090 / sm_89 / 实际可用 3.5 GB**，
**B1/B2/B3/B5 全部要多卡，一项都落不了地**。当前只有 **B4 的写码部分**和 **B7** 不吃 GPU。
（机器变更的完整记录见 `00-INFRA-HANDOFF.md` §0.5。）
