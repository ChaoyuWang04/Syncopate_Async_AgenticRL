...
| **E14** 🆕 | [执行层优化工具箱](E14-bubble.md) | ★ 第一批归因（**待三采复核**：首采窗被证实落在跑尾，交替图读撤回、洞归因可能混入最终存档）：trainer 空档=大洞非微隙（洞内 streamSync×144/1.76s 乒乓）；rollout=微空隙 2.0s ⇒ enforce_eager 探针有据；elementwise 27–31% = compile 靶子；GEMM 仍全 cutlass_80 | **B** | 🟡 **第一批完成** | 🔴 | 🔴 |
