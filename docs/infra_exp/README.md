...
| **E14** 🆕 | [执行层优化工具箱](E14-bubble.md) | ★ 第一批归因定案：trainer 空档=update_actor 内部的 **CPU 同步乒乓大洞**（单洞 streamSync×144/1.76s，>10ms 档占 97%）⇒ CUDA graph 对 trainer 判死刑；rollout 侧相反=微空隙 2.0s ⇒ enforce_eager 探针有据。elementwise 27–31% = compile 靶子 | **B** | 🟡 **第一批完成** | 🔴 | 🔴 |
