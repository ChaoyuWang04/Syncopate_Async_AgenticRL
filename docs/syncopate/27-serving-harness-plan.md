...
> runbook 六张卡 + 传导图；复盘模板回填 08-20 事故；灾备演练 `scripts/dr_drill.sh` RTO 1.5s；SLO 基线
> `_audit/serving_k11/slo_baseline_2026-09-02.txt`）。卡片第一批查询由 `scripts/runbook_queries.py` 逐条真跑。
